...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonTextEdit.clicked.connect(self.pushButtonTextEditClicked)  # TODO подключить слот для вывода текста из textEdit в plainTextEditLog при нажатии на кнопку
        self.pushButtonPlainTextEdit.clicked.connect(self.pushButtonPlainTextEditClicked)  # TODO подключить слот для вывода текста из plaineTextEdit в plainTextEditLog при нажатии на кнопку
        self.pushButtonSpinBox.clicked.connect(self.pushButtonSpinBoxClicked)  # TODO подключить слот для вывода значения из spinBox в plainTextEditLog при нажатии на кнопку
        self.pushButtonDoubleSpinBox.clicked.connect(self.pushButtonDoubleSpinBoxClicked)  # TODO подключить слот для вывода значения из doubleSpinBox в plainTextEditLog при нажатии на кнопку
        self.pushButtonTimeEdit.clicked.connect(self.pushButtonTimeEditClicked)  # TODO подключить слот для вывода времени из timeEdit в plainTextEditLog при нажатии на кнопку
        self.pushButtonDateTimeEdit.clicked.connect(self.pushButtonDateTimeEditClicked)  # TODO подключить слот для вывода времени из dateTimeEdit в plainTextEditLog при нажатии на кнопку
        ...
        self.spinBox.textChanged.connect(self.spinBoxTextChanged)  # TODO подключить слот для вывода значения в plainTextEditLog при изменении значения в spinBox
        self.dateTimeEdit.dateTimeChanged.connect(self.dateTimeEditDateTimeChanged)  # TODO подключить слот для вывода датывремени в plainTextEditLog при изменении датывремени в dateTimeEdit
    ...
    def pushButtonTextEditClicked(self) -> None:
        """
    ...
    def pushButtonPlainTextEditClicked(self) -> None:
        """
    ...
    def pushButtonSpinBoxClicked(self) -> None:
        """
    ...
    def pushButtonDoubleSpinBoxClicked(self) -> None:
        """
    ...
    def pushButtonTimeEditClicked(self) -> None:
        """
    ...
    def pushButtonDateTimeEditClicked(self) -> None:
        """
    ...
    def comboBoxCurrentTextChanged(self) -> None:
        """
        Обработка сигнала currentTextChanged для кнопки comboBox
    ...
    def spinBoxTextChanged(self) -> None:
        """
        Обработка сигнала textChanged для кнопки spinBox
    ...
    def dateTimeEditDateTimeChanged(self) -> None:
        """
        Обработка сигнала dateTimeChanged для кнопки dateTimeEdit
